...
// Single Garba Mahotsav Festive Percussion Soundtrack (Song #4)
const GARBA_AUDIO_SRC = "https://cdn.pixabay.com/download/audio/2022/05/27/audio_1808fbf07a.mp3?filename=indian-percussion-festive-113271.mp3";
...
export default function BackgroundMusicPlayer() {
  ...
  return (
    <>
      ...
      {/* Floating Bottom-Left Garba Sound Player */}
        ...
        <div className="relative group">
          ...
          <div className="relative flex items-center gap-2.5 px-3.5 py-2.5 rounded-full bg-[#110426]/90 border border-amber-500/40 text-white backdrop-blur-xl shadow-2xl transition-all">
            ...
            <div className="flex flex-col text-left pr-1 cursor-pointer select-none" onClick={togglePlay}>
              <div className="flex items-center gap-1 text-[10px] font-black uppercase tracking-wider text-amber-300 font-serif-royal">
                <Sparkles className="w-3 h-3 text-amber-400 shrink-0" />
                <span>Garba Mahotsav Music</span>
              </div>

              <div className="flex items-center gap-1.5 mt-0.5">
                <span className="text-[9px] text-slate-300 font-medium">
                  {isPlaying && !isMuted ? "Festive Sound Loop" : "Sound Paused"}
                </span>
            ...
            <button
              onClick={toggleMute}
              className="p-1.5 rounded-full hover:bg-white/10 text-slate-300 hover:text-white transition-colors border-l border-white/10 pl-2 ml-1"
